...
public final class MatrixServiceGrpc {
  ...
  public static final io.grpc.MethodDescriptor<com.example.grpc.server.grpcserver.Request,
      com.example.grpc.server.grpcserver.MatrixReply> METHOD_MULTIPLY_BLOCK =
      io.grpc.MethodDescriptor.<com.example.grpc.server.grpcserver.Request, com.example.grpc.server.grpcserver.MatrixReply>newBuilder()
          .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
          .setFullMethodName(generateFullMethodName(
              "matrixmult.MatrixService", "MultiplyBlock"))
          .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
              com.example.grpc.server.grpcserver.Request.getDefaultInstance()))
  ...
  public static abstract class MatrixServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void multiplyBlock(com.example.grpc.server.grpcserver.Request request,
    ...
    /**
     */
    public void addBlock(com.example.grpc.server.grpcserver.Request request,
        io.grpc.stub.StreamObserver<com.example.grpc.server.grpcserver.MatrixReply> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                com.example.grpc.server.grpcserver.Request,
  ...
  public static final class MatrixServiceBlockingStub extends io.grpc.stub.AbstractStub<MatrixServiceBlockingStub> {
    ...
    /**
     */
    public com.example.grpc.server.grpcserver.MatrixReply multiplyBlock(com.example.grpc.server.grpcserver.Request request) {
    ...
    /**
     */
    public com.example.grpc.server.grpcserver.MatrixReply addBlock(com.example.grpc.server.grpcserver.Request request) {
      return blockingUnaryCall(
  ...
  public static final class MatrixServiceFutureStub extends io.grpc.stub.AbstractStub<MatrixServiceFutureStub> {
    ...
    public com.google.common.util.concurrent.ListenableFuture<com.example.grpc.server.grpcserver.MatrixReply> multiplyBlock(
        com.example.grpc.server.grpcserver.Request request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_MULTIPLY_BLOCK:
          serviceImpl.multiplyBlock((com.example.grpc.server.grpcserver.Request) request,
              (io.grpc.stub.StreamObserver<com.example.grpc.server.grpcserver.MatrixReply>) responseObserver);
          break;
        case METHODID_ADD_BLOCK:
          serviceImpl.addBlock((com.example.grpc.server.grpcserver.Request) request,
              (io.grpc.stub.StreamObserver<com.example.grpc.server.grpcserver.MatrixReply>) responseObserver);
          break;
        default:
  ...
  private static final class MatrixServiceDescriptorSupplier implements io.grpc.protobuf.ProtoFileDescriptorSupplier {
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.example.grpc.server.grpcserver.MatrixMult.getDescriptor();
    }
  }
